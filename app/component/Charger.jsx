...
export default function Charger() {
    return (
        <div className='bg-purple-950 height-full py-20 px-10'>
            ...
            <div className='flex items-center justify-center mt-10 gap-16'>
                <div className='relative bg-white rounded-lg p-5 flex flex-col items-center gap-3'>
                    <span className="absolute bg-lime-600 text-white px-2 py-1 rounded">বেগুনি</span>
                    <Image src="/purple.jpeg" alt="charger" width={200} height={200} />
                    <div className="text-black text-sm flex items-center gap-6">
                ...
                <div className='relative bg-white rounded-lg p-5 flex flex-col items-center gap-3'>
                    <span className="absolute bg-lime-600 text-white px-2 py-1 rounded">লাইট পিংক</span>
                    <Image src="/purple.jpeg" alt="charger" width={200} height={200} />
                    <div className="text-black text-sm flex items-center gap-6">
                        <span className="text-gray-500 line-through">৳ ৩৫০</span>
                        <span className="text-red-700">৳ ২৯০</span>
                ...
                <div className='relative bg-white rounded-lg p-5 flex flex-col items-center gap-3'>
                    <span className="absolute bg-lime-600 text-white px-2 py-1 rounded">কালো</span>
                    <Image src="/purple.jpeg" alt="charger" width={200} height={200} />
                    <div className="text-black text-sm flex items-center gap-6">
                        <span className="text-gray-500 line-through">৳ ৩৫০</span>
                        <span className="text-red-700">৳ ২৯০</span>
                ...
                <div className='relative bg-white rounded-lg p-5 flex flex-col items-center gap-3'>
                    <span className="absolute bg-lime-600 text-white px-2 py-1 rounded">সাদা</span>
                    <Image src="/purple.jpeg" alt="charger" width={200} height={200} />
                    <div className="text-black text-sm flex items-center gap-6">
                        <span className="text-gray-500 line-through">৳ ৩৫০</span>
                        <span className="text-red-700">৳ ২৯০</span>
