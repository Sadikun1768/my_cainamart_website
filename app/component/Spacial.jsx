...
export default function Spacial() {
  return (
    <div className=' text-center bg-white/90 height-full py-20 px-10 mx-auto'>
        <h1 className='text-black font-extrabold text-4xl'>স্পেশাল অফার চলছে</h1>
        <p className='text-gray-600 mt-5'>৪টি Cable Protector পছন্দমতো কালার সারা বাংলাদেশে হোম ডেলিভারি</p>
        <div className='bg-white w-fit mx-auto mt-10 p-5 rounded-md'>
            <div className='text-pink-600 font-bold'>🎁 বিশেষ অফার</div>
            <div className='flex justify-between text-black border-2 border-gray-300 rounded-md p-3 mt-3'>
                <span>১ সেট</span>
            ...
            <div className='flex justify-between text-black border-2 border-gray-300 rounded-md p-3 mt-3'>
                <span>৩ সেট</span>
                <div>
                 <span className='bg-green-500 py-2 px-2 rounded-full gap-2'>Free Delivery</span>
                <span className='text-red-700 font-bold'>৭৯০ টাকা</span>
                </div>
            
            </div>
            
            <p className='bg-sky-200 text-gray-700 rounded-full py-2 px-4 mt-4'>
