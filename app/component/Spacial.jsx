...
export default function Spacial() {
  return (
    <div className=' text-center bg-white/90 height-full py-20 px-10 mx-auto'>
        <h1 className='text-black font-extrabold text-4xl w-full'>স্পেশাল অফার চলছে</h1>
        ...
        <div className='bg-white w-fit mx-auto mt-10 p-5 rounded-md'>
            ...
            <div className='flex justify-between text-black border-2 border-gray-300 rounded p-3 mt-3'>
                <span>১ সেট</span>
            ...
            <div className='flex justify-between bg-pink-200 text-black border-2 border-red-500 rounded p-3 mt-3'>
                <span>৩ সেট</span>
                <div className='flex items-center gap-2'>
                 <span className='bg-green-500 sm:w-10 md:w-30 lg:w-40 py-2 px-2 rounded-sm text-sm'>Free Delivery</span>
